...
const page = ({ params: { id } }: Props) => {
  ...
  return (
    <div className="mx-[5%] gap-[20px] mb-[300px] h-screen max-xl:flex max-xl:flex-col flex max-xl:justify-center max-xl:items-start items-center">
      <div>
        {coins.map((coin) => (
          <div key={coin.id}>
            {coin.id === id ? (
              <div>
                {isLoading ? (
                  ...
                  <div className="gap-[20px] flex flex-col">
                    ...
                    <div className="w-[700px] max-2xl:hidden rounded-3xl h-[230px] border-2 flex justify-center items-center p-[30px]">
                      ...
                      Investors are drawn to its potential for high returns,
                      while enthusiasts value the promise of financial inclusion
                      and disruption of conventional financial norms. The
                      dynamic crypto landscape continues to evolve, shaping the
